                ...
                itemBuilder: (context, index) {
                  ...
                  return GestureDetector(
                    onTap: () {
                      ...
                      // This should use SocketService().emitNewFirstMessage() to create a chat first
                      // then navigate to MessagesView with the created chat
                      // For now, this is disabled until the new chat creation flow is implemented
                      ...
                      // 1. Call SocketService().emitNewFirstMessage(
                      //      memberIds: [user['id']],
                      //      category: 'FRIENDS', // or get from context
                      //      content: 'Hi!', // initial message
                      //    )
                      // 2. Listen for 'chatCreated' event
                      // 3. Navigate to MessagesView with the new chat
                    },
                    child: UserTile(
                      name: user['name']!,
